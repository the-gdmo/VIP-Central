...
export enum TemplateDefaults {
    ...
    VIPCentralVeteran = "Combined Challenges|🧓 VIP Central Veteran|Reach 5,000 activities, 100,000 XP, and a 180-day streak.|activities>=5000,xp>=100000,longestStreak>=180",
    ...
    LeaderboardHelpPageMessage = "[How to award points with VIP Central.]({helpPage})",
    ...
    NewPostMessage = "To all commentors/OP, if this is your first time experiencing u/vipcentral, " +
    ...
    UserProfileSentMessage = "I just sent you a dm with {target}'s VIP Central profile info.",
    AccountsThatWillNotBeManaged = "vipcentral\nAutoModerator",
...
export const appSettings: SettingsFormField[] = [
    {
        type: "group",
        label: "VIP Central Progression & Rewards",
        fields: [
            {
                type: "paragraph",
            ...
            },
            {
                ...
                label: "Enable VIP Central Audit Logging",
                helpText:
                    "Store important VIP Central actions such as VIP changes, moderator stat changes, nominations, and coin transfers",
                defaultValue: true,
            },
        ],
    },
        ...
        fields: [
            {
                ...
                helpText:
                    "Automatically evaluate and permanently unlock configured VIP Central achievements",
                defaultValue: true,
            },
        ...
        fields: [
            {
                ...
                defaultValue: "VIP Central | {prefix}info",
            },
            {
                type: "string",
        ...
        fields: [
            {
                ...
                helpText: "Accounts that will not be managed by VIP Central. No u/",
        ...
        fields: [
            {
                ...
                helpText:
                    "Receive a message when a new version of VIP Central is released. This is currently a placeholder",
                defaultValue: true,
            },
        ],
        // },
...
function rewardCommandIsValid(event: SettingsFormFieldValidatorEvent<string>) {
    ...
    if (reserved.has(command)) {
        return `"${command}" is reserved by a built-in VIP Central command`;
    }
}
