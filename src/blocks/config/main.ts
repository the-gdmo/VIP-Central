...
Devvit.addMenuItem({
    label: "[VIP Central] - Set User Score",
...
Devvit.addMenuItem({
    label: "[VIP Central] - Add VIP Days",
    forUserType: "moderator",
    location: "comment",
...
Devvit.addMenuItem({
    label: "[VIP Central] - Set Experience",
    forUserType: "moderator",
    location: "comment",
    onPress: handleSetXP,
});
...
Devvit.addMenuItem({
    label: "[VIP Central] - Set Reputation",
    forUserType: "moderator",
    location: "comment",
...
Devvit.addMenuItem({
    label: "[VIP Central] - Remove VIP Status From User",
    forUserType: "moderator",
    location: "comment",
