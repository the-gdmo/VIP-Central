...
export class UserProfile {
    static readonly XP_LEADERBOARD_KEY = "vipcentral:leaderboard:xp";
    static readonly COIN_LEADERBOARD_KEY = "vipcentral:leaderboard:coins";
    static readonly REP_LEADERBOARD_KEY = "vipcentral:leaderboard:rep";
    static readonly STREAK_LEADERBOARD_KEY = "vipcentral:leaderboard:streak";
    static readonly VIP_INDEX_KEY = "vipcentral:vips:expiry";
    static readonly AUDIT_LOG_KEY = "vipcentral:audit:entries";

    static getWeeklyXPLeaderboardKey(date = new Date()): string {
        return `vipcentral:leaderboard:weeklyxp:${getUTCISOWeekKey(date)}`;
    }

    static getMonthlyXPLeaderboardKey(date = new Date()): string {
        return `vipcentral:leaderboard:monthlyxp:${getUTCMonthKey(date)}`;
    }
