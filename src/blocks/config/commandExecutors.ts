...
const NOMINATION_SCORE_KEY = "vipcentral:nominations:score";
const NOMINATION_BY_USER_HASH_KEY = "vipcentral:nominations:by-user";
...
function buildProfileMessage(snapshot: UserProfileSnapshot): string {
    ...
    return (
        `## u/${snapshot.username}'s VIP Central Profile\n\n` +
        `## ⭐ Reputation\n\n` +
        ...
        `---\n\n` +
        `*Profile maintained automatically by VIP Central.*\n` +
        `*Last updated: ${
