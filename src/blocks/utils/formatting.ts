...
export function formatMessage(
    ...
    const footer = `\n\n---\n\n^(I am a bot — [contact the mods of r/${event.subreddit.name}](https://reddit.com/message/compose?to=r/${event.subreddit.name}) with any questions or [r/VIPCentral](https://www.reddit.com/message/compose?to=r/VIPCentral) to talk directly with my developer)`;
